...
**б) На всю инсталляцию, read-only.** Положить `skills/` в каталог развёртывания и
задать в `.env`:
...
Такие навыки не правятся из UI — обновляются перевыкладкой. Для корпоративной
установки это правильный путь: у всех PO одна версия методологии.
