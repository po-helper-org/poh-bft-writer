...
5. v2 автономка (единый растущий документ):
   ...
   Ограничения и договоренности, Документация, Общая информация) + таблица «Вводные»
   с открытыми вопросами + открытое поле с промтом для доведения. Рассчитан на Haiku;
