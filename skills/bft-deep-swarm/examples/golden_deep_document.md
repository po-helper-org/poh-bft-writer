...
На карточках события, площадки и персоны в Direct появляется редактируемый блок «Вопрос-ответ»: контент-менеджер сам публикует и меняет вопросы без релиза, посетитель сайта видит ответы прямо на странице. Область — событие, площадка, персона; заполнение из MRS и FAQ для категорий вне зоны этого БФТ [Summary, созвон 03.07.2026].
...
Заявленная на встрече ценность — самостоятельная публикация вопросов контент-менеджером без релиза и попадание вопросов в поисковую выдачу [Summary §Что делаем]. Количественная цель (прирост SEO-трафика, снижение обращений по частым вопросам, экономия релизов на правки FAQ) на встрече не прозвучала — `[УТОЧНИТЬ у Анастасии Яковлевой]`, привязка к KR/стратегии квартала не обсуждалась.
...
| ФТ-2 | Модерация контента вопроса | `[УТОЧНИТЬ]` | Правило проверки текста вопроса и ответа перед публикацией не определено | `[УТОЧНИТЬ у Анастасии Яковлевой]` | БТ-1, ПТ-1 |
| ФТ-3 | Поведение блока при удалении/архивации карточки | `[УТОЧНИТЬ]` | Судьба блока «Вопрос-ответ» при удалении или архивации карточки события, площадки, персоны не обсуждалась | `[УТОЧНИТЬ у Дмитрия Ананьева]` | БТ-1, ИТ-1 |
...
| НФТ-2 | Конкурентное редактирование | Поведение при одновременном редактировании блока несколькими контент-менеджерами не обсуждалось на встрече — `[УТОЧНИТЬ у Дмитрия Ананьева]` | ПТ-1 |
| НФТ-3 | Безопасность контента вопроса/ответа | Проверка и санитизация текста вопроса и ответа перед публикацией на сайте не обсуждались — `[УТОЧНИТЬ у Дмитрия Ананьева]` | ФТ-2, ИТ-1 |
