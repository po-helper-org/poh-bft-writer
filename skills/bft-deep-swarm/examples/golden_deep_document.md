...
PO подтвердил один организационный риск; неподтверждённые в таблицу не заводятся. Технические риски реализации — индексация сторонним поисковиком, модерация контента, конкурентное редактирование — в раздел не идут: они живут в ФТ и в alt-ветках сценария приёмки.
